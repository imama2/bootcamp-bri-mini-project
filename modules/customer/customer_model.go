...
func ToResGetAllCustomerWithPaging(dm do.ListActorWithPaging) ResGetAllCustomerWithPaging {
...
func ToResponseCustomer(dt do.Customer) Customer {
	return Customer{
		ID:        dt.ID,
...
func ToResponseListCustomer(dt []do.Customer) []Customer {
